...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen overflow-auto">
      ...
      {/* Philippine Destination Gallery */}
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="gallery-container grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {featuredDestinations.map((dest) => (
              <div
                key={dest.title}
                className="gallery-item relative rounded-lg overflow-hidden shadow hover:scale-105 transition cursor-pointer"
              >
                <img
                  src={dest.image}
                  alt={dest.title}
                ...
                <div className="gallery-overlay absolute bottom-0 left-0 right-0 bg-gradient-to-t from-blue-900/80 text-white p-4">
                  ...
                  <p className="text-sm line-clamp-3">{dest.description}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* Dynamic Available Spots Section */}
      <section className="available-spots py-20 bg-gray-50">
        <div className="container mx-auto">
          ...
          {loading ? (
            <div className="h-[500px] animate-pulse bg-gray-200 rounded-xl text-center p-6">
              Loading spots...
            </div>
          ) : spots.length === 0 ? (
            <p className="text-gray-500 text-center">No spots available.</p>
          ) : (
      ...
      {/* Plan Your Philippine Trip Section */}
      ...
      {/* Essential Philippine Travel Tips Section */}
