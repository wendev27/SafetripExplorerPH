    ...
    <div className="flex min-h-screen">
        ...
        <nav className="space-y-2">
          {tabs.map((tab) => (
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-2 rounded text-left transition 
              ${
                activeTab === tab.id
      ...
      <div className="flex-1 p-10 bg-gray-50">
        ...
        <div className="mt-6">
          {activeTab === "spots" && (
            <>
              {/* ---- INSERT YOUR SPOTS TAB CODE HERE ---- */}
              {/* Your original spots JSX */}
              <div>
                {/* Quick Actions */}
          ...
          {activeTab === "bookings" && (
            <>
              {/* ---- INSERT YOUR BOOKINGS TAB CODE HERE ---- */}
              {/* Your original bookings JSX */}
